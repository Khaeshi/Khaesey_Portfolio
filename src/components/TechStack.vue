<template>
  ...
  <div class="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div class="p-4 bg-neutral-50 dark:bg-neutral-700/50 rounded-xl">
      <h3
        class="text-lg md:text-xl lg:text-2xl font-semibold text-neutral-800 dark:text-neutral-200 mb-3"
      >
        Frontend
      </h3>
    ...
    <div class="p-4 bg-neutral-50 dark:bg-neutral-700/50 rounded-xl">
      ...
      <p class="text-md md:text-lg lg:text-xl text-neutral-600 dark:text-neutral-300 text-sm">
        Working with MySQL and MariaDB for data management. Designing efficient database schemas and
